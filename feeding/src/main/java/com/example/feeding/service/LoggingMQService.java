package com.example.feeding.service;

import com.example.feeding.dto.ApiLogDto;
import com.example.feeding.dto.SysLogDto;
...
public class LoggingMQService {
    private static final String SERVICE_NAME = "feeding";
